...
A hotel information store allows brands to upload images for their hotels; each brand has a different way to identify the images, so a hotel can have an image under different name depending on the brand. 
